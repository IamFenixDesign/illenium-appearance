Locales["bg"] = {
    UI = {
        ...
        settings = {
            title = "Цветове",
            subtitle = "Преглед на живо",
            toggle = "Цветове",
            save = "Запази",
            saved = "Запазено",
            reset = "Нулиране",
            preview = "Преглед · незапазено",
            savedStatus = "Цветовете са запазени",
            defaultsStatus = "По подразбиране · незапазено",
            colors = {
                accent = "Акцент",
                accentSoft = "Мек акцент",
                accentText = "Акцентен текст",
                surface = "Повърхност",
                field = "Полета",
                fieldHover = "Полета при ховър",
                border = "Рамки",
                text = "Текст",
                muted = "Вторичен текст",
                ok = "Запази",
                okBg = "Фон запази",
                okBorder = "Рамка запази",
                danger = "Изход",
                dangerBg = "Фон изход",
                dangerBorder = "Рамка изход"
            },
            camera = {
                reset = "Нулиране на камерата",
                move = "Премести камерата",
                hint = "Влачи · Скрол зуум · Alt височина · Enter потвърди"
            }
        }
    },
    outfitManagement = {
    ...
    settingsAccess = {
        ...
        description = "Нямате разрешение да използвате настройките за цветове."
    },
    outfits = {
        import = {
