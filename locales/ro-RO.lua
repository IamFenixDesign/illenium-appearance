Locales["ro-RO"] = {
    UI = {
        ...
        settings = {
            title = "Culori",
            subtitle = "Previzualizare live",
            toggle = "Culori",
            save = "Salvează",
            saved = "Salvat",
            reset = "Resetează",
            preview = "Previzualizare · nesalvat",
            savedStatus = "Culori salvate",
            defaultsStatus = "Implicite · nesalvat",
            colors = {
                accent = "Accent",
                ...
                surface = "Suprafață",
                field = "Câmpuri",
                fieldHover = "Câmpuri hover",
                border = "Borduri",
                text = "Text",
                muted = "Text secundar",
                ok = "Salvează",
                okBg = "Fundal salvează",
                okBorder = "Bordură salvează",
                danger = "Ieșire",
                dangerBg = "Fundal ieșire",
                dangerBorder = "Bordură ieșire"
            },
            camera = {
                reset = "Resetează camera",
                move = "Mută camera",
                hint = "Trage · Scroll zoom · Alt înălțime · Enter confirmă"
            }
        }
    },
    outfitManagement = {
