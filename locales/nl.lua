Locales["nl"] = {
    UI = {
        ...
        settings = {
            title = "Kleuren",
            subtitle = "Live voorbeeld",
            toggle = "Kleuren",
            save = "Opslaan",
            saved = "Opgeslagen",
            reset = "Herstellen",
            preview = "Voorbeeld · niet opgeslagen",
            savedStatus = "Kleuren opgeslagen",
            defaultsStatus = "Standaard · niet opgeslagen",
            colors = {
                accent = "Accent",
                ...
                surface = "Oppervlak",
                field = "Velden",
                fieldHover = "Velden hover",
                border = "Randen",
                text = "Tekst",
                muted = "Secundaire tekst",
                ok = "Opslaan",
                okBg = "Opslaan achtergrond",
                okBorder = "Opslaan rand",
                danger = "Afsluiten",
                dangerBg = "Afsluiten achtergrond",
                dangerBorder = "Afsluiten rand"
            },
            camera = {
                reset = "Camera resetten",
                move = "Camera bewegen",
                hint = "Slepen · Scroll zoom · Alt hoogte · Enter bevestigen"
            }
        }
    },
    outfitManagement = {
