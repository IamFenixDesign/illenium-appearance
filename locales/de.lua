Locales["de"] = {
    UI = {
        ...
        settings = {
            title = "Farben",
            subtitle = "Live-Vorschau",
            toggle = "Farben",
            save = "Speichern",
            saved = "Gespeichert",
            reset = "Zurücksetzen",
            preview = "Vorschau · nicht gespeichert",
            savedStatus = "Farben gespeichert",
            defaultsStatus = "Standard · nicht gespeichert",
            colors = {
                accent = "Akzent",
                accentSoft = "Weicher Akzent",
                accentText = "Akzenttext",
                surface = "Oberfläche",
                field = "Felder",
                fieldHover = "Felder Hover",
                border = "Rahmen",
                text = "Text",
                muted = "Sekundärtext",
                ok = "Speichern",
                okBg = "Speichern Hintergrund",
                okBorder = "Speichern Rahmen",
                danger = "Beenden",
                dangerBg = "Beenden Hintergrund",
                dangerBorder = "Beenden Rahmen"
            },
            camera = {
                reset = "Kamera zurücksetzen",
                move = "Kamera bewegen",
                hint = "Ziehen · Scroll Zoom · Alt Höhe · Enter bestätigen"
            }
        }
    },
    outfitManagement = {
