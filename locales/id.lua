Locales["id"] = {
    UI = {
        ...
        settings = {
            title = "Warna",
            subtitle = "Pratinjau langsung",
            toggle = "Warna",
            save = "Simpan",
            saved = "Tersimpan",
            reset = "Atur ulang",
            preview = "Pratinjau · belum disimpan",
            savedStatus = "Warna disimpan",
            defaultsStatus = "Default · belum disimpan",
            colors = {
                accent = "Aksen",
                accentSoft = "Aksen lembut",
                accentText = "Teks aksen",
                surface = "Permukaan",
                field = "Bidang",
                fieldHover = "Bidang hover",
                border = "Batas",
                text = "Teks",
                muted = "Teks sekunder",
                ok = "Simpan",
                okBg = "Latar simpan",
                okBorder = "Batas simpan",
                danger = "Keluar",
                dangerBg = "Latar keluar",
                dangerBorder = "Batas keluar"
            },
            camera = {
                reset = "Atur ulang kamera",
                move = "Gerakkan kamera",
                hint = "Seret · Scroll zoom · Alt tinggi · Enter konfirmasi"
            }
        }
    },
    outfitManagement = {
