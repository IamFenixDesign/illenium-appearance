Locales["fr"] = {
    UI = {
        ...
        settings = {
            title = "Couleurs",
            subtitle = "Aperçu en direct",
            toggle = "Couleurs",
            save = "Enregistrer",
            saved = "Enregistré",
            reset = "Réinitialiser",
            preview = "Aperçu · non enregistré",
            savedStatus = "Couleurs enregistrées",
            defaultsStatus = "Défauts · non enregistré",
            colors = {
                accent = "Accent",
                accentSoft = "Accent doux",
                accentText = "Texte accent",
                surface = "Surface",
                field = "Champs",
                fieldHover = "Champs survol",
                border = "Bordures",
                text = "Texte",
                muted = "Texte secondaire",
                ok = "Enregistrer",
                okBg = "Fond enregistrer",
                okBorder = "Bordure enregistrer",
                danger = "Quitter",
                dangerBg = "Fond quitter",
                dangerBorder = "Bordure quitter"
            },
            camera = {
                reset = "Réinitialiser la caméra",
                move = "Déplacer la caméra",
                hint = "Glisser · Molette zoom · Alt hauteur · Entrée confirmer"
            }
        }
    },
    outfitManagement = {
