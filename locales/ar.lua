Locales["ar"] = {
    UI = {
        ...
        settings = {
            title = "الألوان",
            subtitle = "معاينة مباشرة",
            toggle = "الألوان",
            save = "حفظ",
            saved = "تم الحفظ",
            reset = "إعادة ضبط",
            preview = "معاينة · غير محفوظ",
            savedStatus = "تم حفظ الألوان",
            defaultsStatus = "الافتراضي · غير محفوظ",
            colors = {
                accent = "تمييز",
                accentSoft = "تمييز ناعم",
                accentText = "نص التمييز",
                surface = "السطح",
                field = "الحقول",
                fieldHover = "تمرير الحقول",
                border = "الحدود",
                text = "النص",
                muted = "نص ثانوي",
                ok = "حفظ",
                ...
                okBorder = "حد الحفظ",
                danger = "خروج",
                dangerBg = "خلفية الخروج",
                dangerBorder = "حد الخروج"
            },
            camera = {
                reset = "إعادة ضبط الكاميرا",
                move = "تحريك الكاميرا",
                hint = "اسحب · عجلة للتكبير · Alt للارتفاع · Enter للتأكيد"
            }
        }
    },
    outfitManagement = {
