Locales["hu"] = {
    UI = {
        ...
        settings = {
            title = "Színek",
            subtitle = "Élő előnézet",
            toggle = "Színek",
            save = "Mentés",
            saved = "Mentve",
            reset = "Visszaállítás",
            preview = "Előnézet · nincs mentve",
            savedStatus = "Színek mentve",
            defaultsStatus = "Alapértelmezett · nincs mentve",
            colors = {
                accent = "Kiemelés",
                accentSoft = "Lágy kiemelés",
                accentText = "Kiemelő szöveg",
                surface = "Felület",
                field = "Mezők",
                fieldHover = "Mezők hover",
                border = "Szegélyek",
                text = "Szöveg",
                muted = "Másodlagos szöveg",
                ok = "Mentés",
                okBg = "Mentés háttér",
                okBorder = "Mentés szegély",
                danger = "Kilépés",
                dangerBg = "Kilépés háttér",
                dangerBorder = "Kilépés szegély"
            },
            camera = {
                reset = "Kamera visszaállítása",
                move = "Kamera mozgatása",
                hint = "Húzd · Görgő zoom · Alt magasság · Enter megerősítés"
            }
        }
    },
    outfitManagement = {
