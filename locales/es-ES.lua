Locales["es-ES"] = {
    UI = {
        modal = {
            save = {
                ...
                description = "¿Querés guardar esta personalización?"
            },
            exit = {
        ...
        settings = {
            title = "Colores",
            subtitle = "Cambios en tiempo real",
            toggle = "Colores",
            save = "Guardar",
            saved = "Guardado",
            reset = "Restablecer",
            preview = "Vista previa · sin guardar",
            savedStatus = "Colores guardados",
            defaultsStatus = "Defaults · sin guardar",
            colors = {
                accent = "Acento",
                accentSoft = "Acento suave",
                accentText = "Texto acento",
                surface = "Superficie",
                field = "Campos",
                fieldHover = "Campos hover",
                border = "Bordes",
                text = "Texto",
                muted = "Texto secundario",
                ok = "Guardar",
                okBg = "Fondo guardar",
                okBorder = "Borde guardar",
                danger = "Salir",
                dangerBg = "Fondo salir",
                dangerBorder = "Borde salir"
            },
            camera = {
                reset = "Reiniciar cámara",
                move = "Mover cámara",
                hint = "Arrastra · Rueda zoom · Alt altura · Enter confirmar"
            }
        }
    },
    outfitManagement = {
    ...
    settingsAccess = {
        title = "Sin permiso",
        description = "No tienes permiso para usar los ajustes de colores."
    },
    outfits = {
        import = {
