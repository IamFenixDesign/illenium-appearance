Locales["cs"] = {
    UI = {
        ...
        settings = {
            title = "Barvy",
            subtitle = "Náhled v reálném čase",
            toggle = "Barvy",
            save = "Uložit",
            saved = "Uloženo",
            reset = "Obnovit",
            preview = "Náhled · neuloženo",
            savedStatus = "Barvy uloženy",
            defaultsStatus = "Výchozí · neuloženo",
            colors = {
                accent = "Akcent",
                accentSoft = "Jemný akcent",
                accentText = "Text akcentu",
                surface = "Povrch",
                field = "Pole",
                fieldHover = "Pole hover",
                border = "Okraje",
                text = "Text",
                muted = "Sekundární text",
                ok = "Uložit",
                okBg = "Pozadí uložit",
                okBorder = "Okraj uložit",
                danger = "Ukončit",
                dangerBg = "Pozadí ukončit",
                dangerBorder = "Okraj ukončit"
            },
            camera = {
                reset = "Obnovit kameru",
                move = "Pohybovat kamerou",
                hint = "Táhni · Kolečko zoom · Alt výška · Enter potvrdit"
            }
        }
    },
    outfitManagement = {
