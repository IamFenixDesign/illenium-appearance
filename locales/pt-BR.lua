Locales["pt-BR"] = {
    UI = {
        ...
        settings = {
            ...
            saved = "Salvo",
            reset = "Redefinir",
            preview = "Pré-visualização · não salvo",
            savedStatus = "Cores salvas",
            defaultsStatus = "Padrões · não salvo",
            colors = {
                accent = "Destaque",
                ...
                ok = "Salvar",
                okBg = "Fundo salvar",
                okBorder = "Borda salvar",
                danger = "Sair",
                dangerBg = "Fundo sair",
                dangerBorder = "Borda sair"
            },
            camera = {
                reset = "Reiniciar câmera",
                move = "Mover câmera",
                hint = "Arraste · Scroll zoom · Alt altura · Enter confirmar"
            }
        }
    },
    outfitManagement = {
    ...
    settingsAccess = {
        title = "Sem permissão",
        description = "Você não tem permissão para usar as configurações de cores."
    },
    outfits = {
        import = {
