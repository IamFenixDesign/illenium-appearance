Locales["it"] = {
    UI = {
        ...
        settings = {
            title = "Colori",
            subtitle = "Anteprima in tempo reale",
            toggle = "Colori",
            save = "Salva",
            saved = "Salvato",
            reset = "Reimposta",
            preview = "Anteprima · non salvato",
            savedStatus = "Colori salvati",
            defaultsStatus = "Predefiniti · non salvato",
            colors = {
                accent = "Accento",
                accentSoft = "Accento soft",
                accentText = "Testo accento",
                surface = "Superficie",
                field = "Campi",
                fieldHover = "Campi hover",
                border = "Bordi",
                text = "Testo",
                muted = "Testo secondario",
                ok = "Salva",
                okBg = "Sfondo salva",
                okBorder = "Bordo salva",
                danger = "Esci",
                dangerBg = "Sfondo esci",
                dangerBorder = "Bordo esci"
            },
            camera = {
                reset = "Reimposta fotocamera",
                move = "Muovi fotocamera",
                hint = "Trascina · Rotella zoom · Alt altezza · Invio conferma"
            }
        }
    },
    outfitManagement = {
    ...
    settingsAccess = {
        ...
        description = "Non hai il permesso di usare le impostazioni dei colori."
    },
    outfits = {
        import = {
