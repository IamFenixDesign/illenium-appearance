Config.Theme = {
    currentTheme = "fenix-hud",
    themes = {
        {
            id = "fenix-hud",
            borderRadius = "10px",
            fontColor = "242, 242, 246",
            fontColorHover = "255, 255, 255",
            fontColorSelected = "221, 214, 254",
            fontFamily = "Inter",
            primaryBackground = "124, 108, 240",
            primaryBackgroundSelected = "107, 92, 224",
            secondaryBackground = "28, 28, 36",
            scaleOnHover = false,
