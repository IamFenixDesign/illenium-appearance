...
Config.PedMenuType = "menu" -- "contextmenu"

Config.EnableJobOutfitsCommand = false -- Enables /joboutfits and /gangoutfits commands

Config.ShowBlips = 1 -- 0 - Hide all, 1 - Show nearest (within BlipDistance), 2 - Show all

-- Distance to show shop blips (only used when ShowBlips = 1)
Config.BlipDistance = 60
